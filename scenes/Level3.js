class Start3 extends Phaser.Scene {
    ...
    create() {
        ...
        const text = this.add.text(480, 350,
            score + `/31 blocks destroyed\nCurrent score: ` + Math.round((score/31 * 100)) + `%\n1: Blue\n2: Red\n3: Purple\n4: Green\n\nClick to continue`,
            {
            font: "24px",
        }
        ).setOrigin(0.5, 0.5);
...
class Level3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('greenPaddle', 'assets/greenPaddle.png');
        this.load.image('greenBall', 'assets/greenBall.png');
    ...
    create() {
        ...
        this.physics.add.collider(ball, greenBricks, hitGreenBrick, null, this);
